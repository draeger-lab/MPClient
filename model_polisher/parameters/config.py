...
class Config(object):
    ...
    """
    swagger_types = {
        'allow_model_to_be_saved_on_server': 'bool',
        'sbml_validation': 'bool',
    ...
    def __init__(self, allow_model_to_be_saved_on_server=None, sbml_validation=None, sbo_terms=None, polishing=None, annotation=None, output='sbml'):  # noqa: E501
    ...
    def output(self, output):
        ...
        :type: str
        """
        allowed_values = ["sbml", "json", "combine"]  # noqa: E501
        if output not in allowed_values:
            raise ValueError(
                "Invalid value for `output` ({0}), must be one of {1}"  # noqa: E501
