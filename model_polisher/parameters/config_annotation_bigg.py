...
class ConfigAnnotationBigg(object):
    ...
    """
    swagger_types = {
        'annotate_with_bigg': 'bool',
        'include_any_uri': 'bool',
    ...
    def __init__(self, annotate_with_bigg=False, include_any_uri=True, document_title_pattern=None, notes=None):  # noqa: E501
